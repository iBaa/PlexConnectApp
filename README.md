...
Based on the experience with PlexConnect ([forum][], [github][]) this App was created as a proof-of-concept of an AppleTV4 Plex client. And to have a look into Swift and the surrounding habitat...
...
Basically, you can do with the code whatever you want - with only one constraint: Don't push binaries from this software, if essentially unmodified, to the Apple AppStore.
